// Initialize Firebase
var config = {
  apiKey: "AIzaSyBNNgGwAkjJsMTkyaB8DucFObkvA748ExE",
  authDomain: "fir-chat-85a3d.firebaseapp.com",
  databaseURL: "https://fir-chat-85a3d.firebaseio.com",
  projectId: "fir-chat-85a3d",
  storageBucket: "fir-chat-85a3d.appspot.com",
  messagingSenderId: "654430235423"
};
    ...
    for (var msgId in values){
      ...
      $("#messages").append(
        `<div class="msg-div ${side}">
            ...
            <div style=" padding: 10px;" class="talk-bubble tri-right ${corner}">
